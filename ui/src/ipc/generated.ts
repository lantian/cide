 ...
 */
export type SplitIntent = { "kind": "newClaude" } | { "kind": "forkPrimary" } | { "kind": "mirror", session: SessionId, continues?: HarnessSession, } | { "kind": "resume", session: SessionId, } | { "kind": "continue", conversation: HarnessSession, } | { "kind": "shell" };
 ...
 */
dirty: boolean, } | { "kind": "settings", section: SettingsSection, } | { "kind": "extension", marketplace: MarketplaceId, extension: ExtensionId, 
/**
