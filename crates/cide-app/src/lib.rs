...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd::diagnostics::docs_lookup,
            cmd::diagnostics::docs_page,
            cmd::diagnostics::tab_open_docs,
            cmd::diagnostics::diagnostics_probe,
            cmd::diagnostics::diagnostics_usages,
            cmd::diagnostics::diagnostics_usages_cancel,
            cmd::diagnostics::diagnostics_completion,
            cmd::diagnostics::diagnostics_completion_cancel,
            cmd::diagnostics::diagnostics_completion_resolve,
